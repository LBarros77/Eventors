		...
		if( $('#gaugeBasic').get(0) ) {
			var target = $('#gaugeBasic'),
				opts = $.extend(true, {}, {
					...
					colorStart: '#2d3f61', // Colors
					colorStop: '#2d3f61', // just experiment with them
